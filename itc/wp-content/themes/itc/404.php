...
<div class="section section-refund-returns page-404">
    <di class="container">
        <div class="refund-returns d-flex justify-content-center">
    ...
    C6.3,2,6.9,1.9,7.5,2l7.7,1.1l4.5-2.7c0.7-0.4,1.4-0.5,2.1-0.3c0.7,0.2,1.3,0.6,1.7,1.3L23.9,2.7z" />
        ...
        <div class="text-center">
            <div class="group-btn">
                <a href="<?= get_home_url() ?>" class="btn btn-brown">Back to homepage</a>
            </div>
        </div>
</div>
</div>
