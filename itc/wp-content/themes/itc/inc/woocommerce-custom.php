...
// * change position button checkout
function output_payment_button() {
    $order_button_text = apply_filters( 'woocommerce_order_button_text', __( 'Checkout', 'woocommerce' ) );
    echo '<div class="group-btn mt-50"><input type="submit" class="btn w-100" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" /></div>';
}
...
// * change position payment mothod checkout
